 ...
 * Menampilkan:
 * - Judul "CLOSING APPS"
 * - Circular progress + persentase
 * - Nama app yang sedang diproses
 * - Progress bar
 * - Tombol stop
 */
class KillerOverlayManager(private val context: Context) {
    ...
    fun show() {
        ...
        try {
            ...
            // Set judul & subtitle
            tvTitle?.text = context.getString(R.string.overlay_closing_apps)
            tvSubtitle?.text = context.getString(R.string.overlay_shutting_down)
    ...
    /**
     * Cek apakah overlay sedang tampil.
     */
