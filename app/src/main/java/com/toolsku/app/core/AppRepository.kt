...
object AppRepository {
    ...
    /**
     * Untuk CLEANER — scan SEMUA app di device (user + system).
     * TIDAK filter exception, TIDAK filter dangerous.
     * Filter cache >= 10 MB dilakukan di CleanerActivity.
     */
    ...
    // =====================================================
    // UNTUK EXCEPTION LIST
    // =====================================================

    /**
     * Ambil app di exception list.
     */
